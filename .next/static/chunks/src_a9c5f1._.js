(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_a9c5f1._.js", {
...
const InteractiveBentoGallery = ({ mediaItems, title, description })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InteractiveBentoGallery.useEffect": ()=>{
            const dragHint = setTimeout({
                "InteractiveBentoGallery.useEffect.dragHint": ()=>{
                    const elements = document.querySelectorAll('.draggable-item');
                    elements.forEach({
                        "InteractiveBentoGallery.useEffect.dragHint": (el, i)=>{
                            setTimeout({
                                "InteractiveBentoGallery.useEffect.dragHint": ()=>{
                                    el.classList.add('drag-hint');
                                    setTimeout({
                                        "InteractiveBentoGallery.useEffect.dragHint": ()=>el.classList.remove('drag-hint')
                                    }["InteractiveBentoGallery.useEffect.dragHint"], 600);
                                }
                            }["InteractiveBentoGallery.useEffect.dragHint"], i * 100);
                        }
                    }["InteractiveBentoGallery.useEffect.dragHint"]);
                }
            }["InteractiveBentoGallery.useEffect.dragHint"], 1500);
            return ({
                "InteractiveBentoGallery.useEffect": ()=>clearTimeout(dragHint)
            })["InteractiveBentoGallery.useEffect"];
        }
    }["InteractiveBentoGallery.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s2(InteractiveBentoGallery, "2xF3rLi28eI+SVQO2S9nTViOEJI=");
...
//# sourceMappingURL=src_a9c5f1._.js.map